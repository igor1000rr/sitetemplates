...
const steps = [
  { icon: '\U0001f4ac', title: 'Расскажите о проекте', desc: 'Заполните форму — что за бизнес, какой нужен сайт' },
  { icon: '\U0001f4cb', title: 'Получите предложение', desc: 'Мы оценим стоимость и сроки в течение 24 часов' },
  { icon: '\U0001f3a8', title: 'Согласуем дизайн', desc: 'Покажем макеты, внесём правки до идеала' },
  { icon: '\U0001f680', title: 'Запускаем', desc: 'Готовый сайт с настроенным хостингом и SEO' },
]
